...
const points: Point[] = [
  {
    id: 1,
    description: quest[0]?.description ?? "Unknown",
    images: quest[0]?.images ?? [],
    x: 20,
    y: 30,
  },
  {
    id: 2,
    description: quest[1]?.description ?? "Unknown",
    images: quest[1]?.images ?? [],
    x: 50,
    y: 20,
  },
  {
    id: 3,
    description: quest[2]?.description ?? "Unknown",
    images: quest[2]?.images ?? [],
    x: 70,
    y: 40,
  },
  {
    id: 4,
    description: quest[3]?.description ?? "Unknown",
    images: quest[3]?.images ?? [],
    x: 30,
    y: 60,
  },
  {
    id: 5,
    description: quest[4]?.description ?? "Unknown",
    images: quest[4]?.images ?? [],
    x: 60,
    y: 70,
  },
];
